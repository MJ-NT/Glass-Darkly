...
This file contains a list of files for GitHub to ignore, and includes the python cache, the virtual environment, the `.env` and `game.db` files (not detailed here).
